"""
Genera la base de conocimiento de ejemplo de TechRetail Solutions S.R.L.
en los 8 formatos de documento más comunes (PDF, Word, Excel, PowerPoint,
...
mismos planes, mismas integraciones).
